...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Start AWS EC2 instances based on service name.")
    ...
    instance_ids, target_group_arn = service_starter(args.service)
    instanceStarter(instance_ids=instance_ids,
                    target_group_arn=target_group_arn)
